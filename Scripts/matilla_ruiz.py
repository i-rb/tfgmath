...
a=pd.read_csv("IBM.csv") #se necesita subir el csv IBM.csv
...
test_entropia(d_ln_a)

parameters(10,5)

test_entropia(d_ln_a,w=10,m=5)

### para todos los residuos

arma=pd.read_csv("arma11.csv",header=None).values

test_entropia(arma,w=10,m=5)

egar=pd.read_csv("egar21.csv",header=None).values
garc=pd.read_csv("garc11.csv",header=None).values

test_entropia(garc,w=10,m=5)

test_entropia(egar,w=10,m=5)
